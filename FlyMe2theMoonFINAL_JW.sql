-- --------------------------------------------------------------------------------
-- Name: Bob Nields (& edits by Josephine Wooldridge!)
...
(
	...
	,decFlightCost				DECIMAL			NOT NULL
...
-- 16	TEmployees						TPilots						intPilotEmployeeID
-- 17	TEmployees						TAttendants					intAttendantEmployeeID
...
--16
ALTER TABLE TEmployees	 ADD CONSTRAINT TEmployee_TPilots_FK 
FOREIGN KEY ( intPilotID ) REFERENCES TPilots ( intPilotID )

--17
ALTER TABLE TEmployees	 ADD CONSTRAINT TEmployee_TAttendants_FK 
FOREIGN KEY ( intAttendantID ) REFERENCES TAttendants ( intAttendantID )
...
VALUES				  (1, 'Knelly', 'Nervious', '321 Elm St.', 'Cincinnati', 1, '45201', '5135553333', 'nnelly@gmail.com', 'knervious', 'SecurePasswordTehe', '1/23/2004')
					 ,(2, 'Orville', 'Waite', '987 Oak St.', 'Cleveland', 1, '45218', '5135556333', 'owright@gmail.com', 'orvilleiscool', 'InsecurePasswordTehe', '11/27/2003')
					 ,(3, 'Eileen', 'Awnewe', '1569 Windisch Rd.', 'Dayton', 1, '45069', '5135555333', 'eonewe1@yahoo.com', 'eileeniscooler', '12345!!!', '4/21/2000')
					 ,(4, 'Bob', 'Eninocean', '44561 Oak Ave.', 'Florence', 2, '45246', '8596663333', 'bobenocean@gmail.com', 'a', 'a', '2/13/2001')
					 ,(5, 'Ware', 'Hyjeked', '44881 Pine Ave.', 'Aurora', 3, '45546', '2825553333', 'Hyjekedohmy@gmail.com', 'help', 'ohno', '6/21/2005')
					 ,(6, 'Kay', 'Oss', '4484 Bushfield Ave.', 'Lawrenceburg', 3, '45546', '2825553333', 'wehavekayoss@gmail.com', 'ImOld1994', '2secure4u', '5/30/1994')
...
VALUES				  (1, 'admin', 'admin', 'Admin', null, null)
					 ,(2, 'MTAttendant', 'password','Attendant', null, 1)
					 ,(3, 'SUAttendant', 'aaa', 'Attendant', null, 2)
					 ,(4, 'BBAttendant', 'yippee', 'Attendant', null, 3)
					 ,(5, 'MAAttendant', 'genericDogName97!', 'Attendant', null, 4)
					 ,(6, 'WTAttendant', 'm0st5ecur3Pa55w0rd!', 'Attendant', null, 5)
					 ,(7, 'TSPilot', 'imSoCool', 'Pilot', 1, null)
					 ,(8, 'ISPilot', 'placeholderpass', 'Pilot', 2, null)
					 ,(9, 'HEPilot', '12345', 'Pilot', 3, null)
					 ,(10, 'IKPilot', 'sleepy', 'Pilot', 4, null)
					 ,(11, 'REPilot', '!wowPassword!', 'Pilot', 5, null)
