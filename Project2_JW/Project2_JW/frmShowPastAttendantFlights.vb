Public Class frmShowPastAttendantFlights
    ' Show Past Attendant Flights: 
    ' displays past attendant flights in a list box based on current date

    ' WORKS + COMMENTED + MODULARIZED

    '----------------------------------------------------------------------------------------------------
    ' on form load, display past flights based on current attendant ID
    '----------------------------------------------------------------------------------------------------
    Private Sub frmShowPastAttendantFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            cmdSelect = New OleDb.OleDbCommand("uspGetAttendantPastFlights", m_conAdministrator)
