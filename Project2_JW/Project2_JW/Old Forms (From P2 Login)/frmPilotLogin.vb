Public Class frmPilotLogin
    ...
    '----------------------------------------------------------------------------------------------------
    ' If pilot is selected, save ID, open pilot main menu, and hide pilot login form
    '----------------------------------------------------------------------------------------------------
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        If cboPilotName.SelectedIndex > -1 Then
            strCurrentPilotID = cboPilotName.SelectedValue
            frmPilotMainMenu.Show()
            Me.Hide()
        Else
            MessageBox.Show("Pilot must be selected to log in.")
        End If
    End Sub
    ...
    '----------------------------------------------------------------------------------------------------
    Private Sub frmPilotLogin_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        frmUserSelect.Show()
    End Sub
