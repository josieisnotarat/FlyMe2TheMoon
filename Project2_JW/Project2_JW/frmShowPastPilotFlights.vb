Public Class frmShowPastPilotFlights
    ' Show Past Pilot Flights: 
    ' displays past pilot flights in a list box based on current date

    ' WORKS + COMMENTED + MODULARIZED

    '----------------------------------------------------------------------------------------------------
    ' on form load, display past flights based on current pilot ID
    '----------------------------------------------------------------------------------------------------
    Private Sub frmShowPastAttendantFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            cmdSelect = New OleDb.OleDbCommand("uspGetPilotPastFlights", m_conAdministrator)
