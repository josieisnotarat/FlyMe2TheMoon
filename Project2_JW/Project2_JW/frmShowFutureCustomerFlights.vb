Public Class frmShowFutureCustomerFlights
    ' Show Future Customer Flights: 
    ' displays future customer flights in a list box based on current date

    ' WORKS + COMMENTED + MODULARIZED

    '----------------------------------------------------------------------------------------------------
    ' on form load, display future flights based on current passenger ID
    '----------------------------------------------------------------------------------------------------
    Private Sub frmShowFutureCustomerFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            cmdSelect = New OleDb.OleDbCommand("uspGetCustomerFutureFlights", m_conAdministrator)
