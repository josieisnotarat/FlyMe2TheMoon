Public Class frmDeletePilots
    ...
    ' - deletes information from TPilotFlights and TPilots with associated PilotID

    ' WORKS + COMMENTED + MODULARIZED


    '----------------------------------------------------------------------------------------------------
    ' On form Load, add pilot names to combo box.
    '----------------------------------------------------------------------------------------------------
    ...
    '----------------------------------------------------------------------------------------------------
    ' on button click, delete from TPilotFlights and TPilots based on selection
    '----------------------------------------------------------------------------------------------------
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            result = MessageBox.Show("Are you sure you want to Delete Pilot: " & cboPilotName.Text & "?", "Confirm Deletion", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question)
            ...
            Select Case result
                ...
                Case DialogResult.Yes
                    ...
                    cmdDelete.CommandText = "EXECUTE uspDeletePilotEmployees '" & cboPilotName.SelectedValue.ToString & "'"
                    ...
                    cmdDelete.CommandText = "EXECUTE uspDeletePilotFlights '" & cboPilotName.SelectedValue.ToString & "'"
                    cmdDelete.CommandType = CommandType.StoredProcedure
                    ...
                    cmdDelete.CommandText = "EXECUTE uspDeletePilots '" & cboPilotName.SelectedValue.ToString & "'"
                    cmdDelete.CommandType = CommandType.StoredProcedure
