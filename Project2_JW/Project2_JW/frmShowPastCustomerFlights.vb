Public Class frmShowPastCustomerFlights
    ' Show Past Customer Flights: 
    ' displays past customer flights in a list box based on current date

    ' WORKS + COMMENTED + MODULARIZED

    '----------------------------------------------------------------------------------------------------
    ' on form load, display past flights based on current passenger ID
    '----------------------------------------------------------------------------------------------------
    Private Sub frmShowPastCustomerFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            cmdSelect = New OleDb.OleDbCommand("uspGetCustomerPastFlights", m_conAdministrator)
